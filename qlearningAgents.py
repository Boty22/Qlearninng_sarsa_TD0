...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        print "q_next_state_on_policy", q_max
        ...
        print  "updated state", self.q[ (state, action) ]        
        ...
        print "q_next_state_on_policy", q_next_state_on_policy
        print "nextState", nextState
        self.q[ (state, action) ] = (1-self.alpha) * self.getQValue(state,action)+ \
                                      self.alpha*(reward +  self.discount * q_next_state_on_policy)
        print "reward" , reward                              
        print  "current state", self.getQValue(state, action)
        #print 
